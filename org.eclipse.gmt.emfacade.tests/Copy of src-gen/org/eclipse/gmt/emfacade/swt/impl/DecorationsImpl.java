...
public abstract class DecorationsImpl extends CanvasImpl implements Decorations {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMenuBar(Menu newMenuBar, NotificationChain msgs) {
		Menu oldMenuBar = menuBar;
		menuBar = newMenuBar;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setMenuBar(Menu newMenuBar) {
		if (newMenuBar != menuBar) {
			NotificationChain msgs = null;
			if (menuBar != null)
				msgs = ((InternalEObject)menuBar).eInverseRemove(this, SwtPackage.MENU__PARENT, Menu.class, msgs);
			if (newMenuBar != null)
				msgs = ((InternalEObject)newMenuBar).eInverseAdd(this, SwtPackage.MENU__PARENT, Menu.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SwtPackage.DECORATIONS__MENU_BAR:
				...
				return basicSetMenuBar((Menu)otherEnd, msgs);
		}
