...
public class SwtPackageImpl extends EPackageImpl implements SwtPackage {
	 ...
	 * @generated
	 */
	public EReference getMenu_Parent() {
	 ...
	 * @generated
	 */
	public EAttribute getMenu_TextOrientationStyle() {
	...
	public void createPackageContents() {
		...
		createEReference(menuEClass, MENU__PARENT);
		createEReference(menuEClass, MENU__PARENT_ITEM);
		createEAttribute(menuEClass, MENU__TEXT_ORIENTATION_STYLE);
	...
	public void initializePackageContents() {
		...
		initEReference(getDecorations_MenuBar(), this.getMenu(), this.getMenu_Parent(), "menuBar", null, 0, 1, Decorations.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getShell_Alpha(), theEcorePackage.getEInt(), "alpha", null, 0, 1, Shell.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(menuEClass, Menu.class, "Menu", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMenu_Parent(), this.getDecorations(), this.getDecorations_MenuBar(), "parent", null, 0, 1, Menu.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMenu_TextOrientationStyle(), this.getTextOrientationStyle(), "textOrientationStyle", null, 0, 1, Menu.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMenu_Enabled(), theEcorePackage.getEBoolean(), "enabled", null, 0, 1, Menu.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMenu_Visible(), theEcorePackage.getEBoolean(), "visible", null, 0, 1, Menu.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(menuItemStyleEEnum, MenuItemStyle.NONE);
		...
		initEDataType(imageRefEDataType, URI.class, "ImageRef", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
