...
public abstract class ShapeBinder <Model extends Shape, View extends org.eclipse.draw2d.Shape>
	...
	public void updateView(Model eObject, View object, EStructuralFeature feature, IBinderContext context) {
		...
		if (feature == Draw2dPackage.eINSTANCE.getShape_LineStyle()) {
			if (lineStyle_Association.updateView(eObject, object, feature, LineStyle.class, context)) {
				return;
			}
		}else 
		if (feature == Draw2dPackage.eINSTANCE.getShape_LineCap()) {
			if (lineCap_Association.updateView(eObject, object, feature, CapStyle.class, context)) {
				return;
			}
		}else 
		if (feature == Draw2dPackage.eINSTANCE.getShape_LineJoin()) {
			if (lineJoin_Association.updateView(eObject, object, feature, JoinStyle.class, context)) {
				return;
			}
		}else 
		if (feature == Draw2dPackage.eINSTANCE.getShape_LineDash()) {
			if (lineDash_Association.updateView(eObject.getLineDash(), object, feature, Float.class, context)) {
				return;
			}
		}else 
		...
		if (feature == Draw2dPackage.eINSTANCE.getShape_LineMiterLimit()) {
			if (lineMiterLimit_Association.updateView(eObject, object, feature, Integer.class, context)) {
				return;
			}
		}
	...
	public void updateView(Model eObject, View object, Notification notification, IBinderContext context) {
		if (notification.getFeature() == Draw2dPackage.eINSTANCE.getShape_LineDash()) {
			if (lineDash_Association.updateView(eObject.getLineDash(), object, notification, Float.class, context)) {
				return;
			}
		}
...
object
		...
		if (feature == Draw2dPackage.eINSTANCE.getShape_LineDash()) {
			lineDash_Association.disposeView(
			eObject.getLineDash(), object, feature, (Float) child, (Float) childObject
			, context);
			return;
		}else 
		if (feature == Draw2dPackage.eINSTANCE.getShape_LineDashOffset()) {
...
object
	...
	private org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Shape, LineStyle, org.eclipse.draw2d.Shape, LineStyle> lineStyle_Association = new org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Shape, LineStyle, org.eclipse.draw2d.Shape, LineStyle>(
		new Shape_lineStyle()
	);
	
	private org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Shape, CapStyle, org.eclipse.draw2d.Shape, CapStyle> lineCap_Association = new org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Shape, CapStyle, org.eclipse.draw2d.Shape, CapStyle>(
		new Shape_lineCap()
	);
	
	private org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Shape, JoinStyle, org.eclipse.draw2d.Shape, JoinStyle> lineJoin_Association = new org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Shape, JoinStyle, org.eclipse.draw2d.Shape, JoinStyle>(
		new Shape_lineJoin()
	);
	
	private org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Shape, Float, org.eclipse.draw2d.Shape, Float> lineDash_Association = new org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Shape, Float, org.eclipse.draw2d.Shape, Float>(
		new Shape_lineDash()
	);
	...
	private org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Shape, Integer, org.eclipse.draw2d.Shape, Integer> lineMiterLimit_Association = new org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Shape, Integer, org.eclipse.draw2d.Shape, Integer>(
