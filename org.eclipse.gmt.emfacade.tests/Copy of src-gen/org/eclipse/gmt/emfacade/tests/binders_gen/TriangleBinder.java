...
public  class TriangleBinder <Model extends Triangle, View extends org.eclipse.draw2d.Triangle>
	...
	public void updateView(Model eObject, View object, EStructuralFeature feature, IBinderContext context) {
		if (feature == Draw2dPackage.eINSTANCE.getTriangle_Orientation()) {
			if (orientation_Association.updateView(eObject, object, feature, Orientation.class, context)) {
				return;
			}
		}else 
		if (feature == Draw2dPackage.eINSTANCE.getTriangle_Direction()) {
			if (direction_Association.updateView(eObject, object, feature, Direction.class, context)) {
				return;
			}
		}
...
object
	...
	private org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Triangle, Orientation, org.eclipse.draw2d.Triangle, Orientation> orientation_Association = new org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Triangle, Orientation, org.eclipse.draw2d.Triangle, Orientation>(
		new Triangle_orientation()
	);
	
	private org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Triangle, Direction, org.eclipse.draw2d.Triangle, Direction> direction_Association = new org.eclipse.gmt.emfacade.builder.strategies.GetSetStrategy1.Impl<Triangle, Direction, org.eclipse.draw2d.Triangle, Direction>(
