...
public class SwtBinderFactory extends org.eclipse.gmt.emfacade.swt.util.SwtAdapterFactory {
	...
	public boolean isFactoryForType(Object type) {
		return IBinder.class.equals(type);
			...
			private IBinder<?, ?> passwordTextBinder = null;
			@Override
			public IBinder<?, ?> createPasswordTextAdapter() {
				if (passwordTextBinder == null) {
					passwordTextBinder = new PasswordTextBinder<PasswordText, org.eclipse.swt.widgets.Text>();
				}
				return passwordTextBinder;
			}
			
			private IBinder<?, ?> searchTextBinder = null;
			@Override
			public IBinder<?, ?> createSearchTextAdapter() {
				if (searchTextBinder == null) {
					searchTextBinder = new SearchTextBinder<SearchText, org.eclipse.swt.widgets.Text>();
				}
				return searchTextBinder;
			}
