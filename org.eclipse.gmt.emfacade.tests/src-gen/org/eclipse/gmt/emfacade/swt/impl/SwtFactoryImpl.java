...
public class SwtFactoryImpl extends EFactoryImpl implements SwtFactory
{
  ...
  public EObject create(EClass eClass)
  {
		switch (eClass.getClassifierID()) {
			...
			case SwtPackage.MENU_BAR: return createMenuBar();
			case SwtPackage.MENU_ITEM: return createMenuItem();
			case SwtPackage.TOOL_BAR: return createToolBar();
			case SwtPackage.TOOL_ITEM: return createToolItem();
			case SwtPackage.COOL_BAR: return createCoolBar();
			case SwtPackage.COOL_ITEM: return createCoolItem();
			case SwtPackage.LABEL: return createLabel();
			case SwtPackage.SEPARATOR: return createSeparator();
			...
			case SwtPackage.SLIDER: return createSlider();
			case SwtPackage.SPINNER: return createSpinner();
			case SwtPackage.PROGRESS_BAR: return createProgressBar();
			case SwtPackage.DATE_TIME: return createDateTime();
			case SwtPackage.BROWSER: return createBrowser();
  ...
  public Object createFromString(EDataType eDataType, String initialValue)
  {
		switch (eDataType.getClassifierID()) {
			case SwtPackage.PROGRESS_STATE:
				return createProgressStateFromString(eDataType, initialValue);
			...
			case SwtPackage.MENU_STYLE:
				return createMenuStyleFromString(eDataType, initialValue);
  ...
  public String convertToString(EDataType eDataType, Object instanceValue)
  {
		switch (eDataType.getClassifierID()) {
			case SwtPackage.PROGRESS_STATE:
				return convertProgressStateToString(eDataType, instanceValue);
			case SwtPackage.SYSTEM_COLORS:
			...
			case SwtPackage.MENU_STYLE:
				return convertMenuStyleToString(eDataType, instanceValue);
			case SwtPackage.MENU_ITEM_STYLE:
  ...
  {
		CoolBarImpl coolBar = new CoolBarImpl();
		return coolBar;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public CoolItem createCoolItem()
  {
		CoolItemImpl coolItem = new CoolItemImpl();
		return coolItem;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public ProgressState createProgressStateFromString(EDataType eDataType, String initialValue)
  {
		ProgressState result = ProgressState.get(initialValue);
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public String convertProgressStateToString(EDataType eDataType, Object instanceValue)
  {
  ...
  /**
	 ...
	 * @generated
	 */
	public MenuStyle createMenuStyleFromString(EDataType eDataType, String initialValue) {
		MenuStyle result = MenuStyle.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertMenuStyleToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
  ...
  public String convertImageRefToString(EDataType eDataType, Object instanceValue)
  {
	...
	public URI createURIFromString(EDataType eDataType, String initialValue) {
		URI uri = null;
		try {
			uri = URI.createURI(initialValue);
		} catch (Exception e) {
		}
		return uri;
	}
	...
	public Point createPointFromString(EDataType eDataType, String initialValue) {
		return (initialValue != null ? Util.parse(initialValue, "(\\d*)[ ,;](\\d*)", Integer.TYPE, 0, Point.class) : null);
	}
