 ...
 *   <li>{@link org.eclipse.gmt.emfacade.swt.impl.ControlImpl#getSize <em>Size</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ControlImpl extends WidgetImpl implements Control
{
  ...
  /**
	...
	public void setSize(Point newSize) {
		...
		size = newSize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SwtPackage.CONTROL__SIZE, oldSize, size));
	}
