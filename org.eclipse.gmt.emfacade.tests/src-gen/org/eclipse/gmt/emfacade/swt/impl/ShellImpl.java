 ...
 *   <li>{@link org.eclipse.gmt.emfacade.swt.impl.ShellImpl#getDefaultButton <em>Default Button</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ShellImpl extends DecorationsImpl implements Shell
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  protected static final TrimStyle TRIM_STYLE_EDEFAULT = TrimStyle.NOT_TRIM;
  ...
  /**
	 * The cached value of the '{@link #getDefaultButton() <em>Default Button</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
  ...
  /**
	...
	public Button getDefaultButton() {
		if (defaultButton != null && defaultButton.eIsProxy()) {
			InternalEObject oldDefaultButton = (InternalEObject)defaultButton;
			defaultButton = (Button)eResolveProxy(oldDefaultButton);
			if (defaultButton != oldDefaultButton) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SwtPackage.SHELL__DEFAULT_BUTTON, oldDefaultButton, defaultButton));
			}
		}
	 ...
	 * @generated
	 */
	public Button basicGetDefaultButton() {
		return defaultButton;
	}
	...
	public void setDefaultButton(Button newDefaultButton) {
		Button oldDefaultButton = defaultButton;
		defaultButton = newDefaultButton;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SwtPackage.SHELL__DEFAULT_BUTTON, oldDefaultButton, defaultButton));
	}
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
		switch (featureID) {
			...
			case SwtPackage.SHELL__ALPHA:
				return getAlpha();
			case SwtPackage.SHELL__DEFAULT_BUTTON:
				if (resolve) return getDefaultButton();
				return basicGetDefaultButton();
		}
  ...
  public void eSet(int featureID, Object newValue)
  {
		switch (featureID) {
			...
			case SwtPackage.SHELL__ALPHA:
				...
				return;
			case SwtPackage.SHELL__DEFAULT_BUTTON:
				setDefaultButton((Button)newValue);
				return;
		}
