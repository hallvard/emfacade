...
public class SwtSwitch<T1> extends Switch<T1>
{
  ...
  protected T1 doSwitch(int classifierID, EObject theEObject)
  {
		switch (classifierID) {
			...
			case SwtPackage.ABSTRACT_MENU: {
				AbstractMenu abstractMenu = (AbstractMenu)theEObject;
				T1 result = caseAbstractMenu(abstractMenu);
				if (result == null) result = caseWidget(abstractMenu);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SwtPackage.MENU_BAR: {
				...
				if (result == null) result = caseAbstractMenu(menuBar);
  ...
  /**
	 ...
	 * @generated
	 */
	public T1 caseAbstractMenu(AbstractMenu object) {
		return null;
	}
