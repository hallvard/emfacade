 ...
 *   <li>{@link org.eclipse.gmt.emfacade.swt.Shell#getDefaultButton <em>Default Button</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Shell extends Decorations
{
  ...
  void setAlpha(int value);
		...
		/**
	 * Returns the value of the '<em><b>Default Button</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Default Button</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Default Button</em>' reference.
	 * @see #setDefaultButton(Button)
	 * @see org.eclipse.gmt.emfacade.swt.SwtPackage#getShell_DefaultButton()
	 * @model
	 * @generated
	 */
	Button getDefaultButton();
		...
		/**
	 * Sets the value of the '{@link org.eclipse.gmt.emfacade.swt.Shell#getDefaultButton <em>Default Button</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Default Button</em>' reference.
	 * @see #getDefaultButton()
	 * @generated
	 */
	void setDefaultButton(Button value);
