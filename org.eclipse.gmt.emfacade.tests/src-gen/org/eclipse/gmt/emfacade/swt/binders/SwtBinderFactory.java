...
public class SwtBinderFactory extends org.eclipse.gmt.emfacade.swt.util.SwtAdapterFactory {
	...
	public boolean isFactoryForType(Object type) {
		return IBinder.class.equals(type);
			...
			private IBinder<?, ?> sliderBinder = null;
			@Override
			public IBinder<?, ?> createSliderAdapter() {
				if (sliderBinder == null) {
					sliderBinder = new SliderBinder<Slider, org.eclipse.swt.widgets.Slider>();
				}
				return sliderBinder;
			}
			
			private IBinder<?, ?> spinnerBinder = null;
			@Override
			public IBinder<?, ?> createSpinnerAdapter() {
				if (spinnerBinder == null) {
					spinnerBinder = new SpinnerBinder<Spinner, org.eclipse.swt.widgets.Spinner>();
				}
				return spinnerBinder;
			}
			
			private IBinder<?, ?> progressBarBinder = null;
			@Override
			public IBinder<?, ?> createProgressBarAdapter() {
				if (progressBarBinder == null) {
					progressBarBinder = new ProgressBarBinder<ProgressBar, org.eclipse.swt.widgets.ProgressBar>();
				}
				return progressBarBinder;
			}
			
			private IBinder<?, ?> dateTimeBinder = null;
			@Override
			public IBinder<?, ?> createDateTimeAdapter() {
				if (dateTimeBinder == null) {
					dateTimeBinder = new DateTimeBinder<DateTime, org.eclipse.swt.widgets.DateTime>();
				}
				return dateTimeBinder;
			}
			
			private IBinder<?, ?> browserBinder = null;
			@Override
			public IBinder<?, ?> createBrowserAdapter() {
				if (browserBinder == null) {
					browserBinder = new BrowserBinder<Browser, org.eclipse.swt.browser.Browser>();
				}
				return browserBinder;
			}
