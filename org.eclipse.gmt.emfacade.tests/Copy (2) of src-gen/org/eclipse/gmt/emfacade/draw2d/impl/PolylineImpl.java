 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.emfacade.draw2d.impl.PolylineImpl#getTolerance <em>Tolerance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PolylineImpl extends PointListShapeImpl implements Polyline {
	/**
	...
	protected EClass eStaticClass() {
		return Draw2dPackage.Literals.POLYLINE;
	}
	...
	public void setTolerance(int newTolerance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Draw2dPackage.POLYLINE__TOLERANCE, oldTolerance, tolerance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Draw2dPackage.POLYLINE__TOLERANCE:
				return getTolerance();
		}
