...
public interface SwtFactory extends EFactory
{
   ...
   * @generated
   */
  SwtFactory eINSTANCE = org.eclipse.gmt.emfacade.swt.impl.SwtFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Cool Bar</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Cool Bar</em>'.
   * @generated
   */
  CoolBar createCoolBar();

  /**
   * Returns a new object of class '<em>Cool Item</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Cool Item</em>'.
   * @generated
   */
  CoolItem createCoolItem();
  ...
  /**
   * Returns a new object of class '<em>Password Text</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Password Text</em>'.
   * @generated
   */
  PasswordText createPasswordText();

  /**
   * Returns a new object of class '<em>Search Text</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Search Text</em>'.
   * @generated
   */
  SearchText createSearchText();

  /**
   * Returns a new object of class '<em>Interval Control</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Interval Control</em>'.
   * @generated
   */
  IntervalControl createIntervalControl();

  /**
   * Returns a new object of class '<em>Interval Selector</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Interval Selector</em>'.
   * @generated
   */
  IntervalSelector createIntervalSelector();
   ...
   * @generated
   */
  FormAttachment createFormAttachment();
  ...
  /**
   * Returns a new object of class '<em>Tree Column</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Tree Column</em>'.
   * @generated
   */
