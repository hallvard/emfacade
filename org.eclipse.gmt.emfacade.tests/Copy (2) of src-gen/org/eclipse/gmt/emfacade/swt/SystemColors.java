...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>System Colors</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.gmt.emfacade.swt.SwtPackage#getSystemColors()
 * @model
 * @generated
 */
public enum SystemColors implements Enumerator
{
   ...
   * @generated
   */
  private static final SystemColors[] VALUES_ARRAY =
    new SystemColors[]
    {
      RED,
      GREEN,
  ...
  /**
   * A public read-only list of all the '<em><b>System Colors</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>System Colors</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>System Colors</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>System Colors</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
