...
public class SwtFactoryImpl extends EFactoryImpl implements SwtFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case SwtPackage.INTERVAL_CONTROL: return createIntervalControl();
      case SwtPackage.INTERVAL_SELECTOR: return createIntervalSelector();
   ...
   * @generated
   */
  public IntervalControl createIntervalControl()
  {
    IntervalControlImpl intervalControl = new IntervalControlImpl();
   ...
   * @generated
   */
  public IntervalSelector createIntervalSelector()
  {
    IntervalSelectorImpl intervalSelector = new IntervalSelectorImpl();
