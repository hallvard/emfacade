...
* generated by Xtext
*/
package org.eclipse.gmt.ui.contentassist.antlr;
...
public class EmfacadeParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.gmt.ui.contentassist.antlr.internal.InternalEmfacadeParser createParser() {
		org.eclipse.gmt.ui.contentassist.antlr.internal.InternalEmfacadeParser result = new org.eclipse.gmt.ui.contentassist.antlr.internal.InternalEmfacadeParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getEClassifierMappingAccess().getAlternatives(), "rule__EClassifierMapping__Alternatives");
					put(grammarAccess.getEClassMappingAccess().getAlternatives_7_2_0(), "rule__EClassMapping__Alternatives_7_2_0");
					put(grammarAccess.getNamePatternAccess().getAlternatives(), "rule__NamePattern__Alternatives");
					put(grammarAccess.getFeatureMappingStrategyMethodPatternAccess().getTargetMemberAlternatives_2_0(), "rule__FeatureMappingStrategyMethodPattern__TargetMemberAlternatives_2_0");
					put(grammarAccess.getImportDirectiveAccess().getImportedNamespaceAlternatives_1_0(), "rule__ImportDirective__ImportedNamespaceAlternatives_1_0");
					...
					put(grammarAccess.getFacadeModelAccess().getGroup(), "rule__FacadeModel__Group__0");
					put(grammarAccess.getFacadeModelAccess().getGroup_3(), "rule__FacadeModel__Group_3__0");
					put(grammarAccess.getFacadeModelAccess().getGroup_4(), "rule__FacadeModel__Group_4__0");
					put(grammarAccess.getFacadeModelAccess().getGroup_4_2(), "rule__FacadeModel__Group_4_2__0");
					put(grammarAccess.getFacadeModelAccess().getGroup_7(), "rule__FacadeModel__Group_7__0");
					put(grammarAccess.getFacadeModelAccess().getGroup_9(), "rule__FacadeModel__Group_9__0");
					put(grammarAccess.getFacadeModelAccess().getGroup_9_3(), "rule__FacadeModel__Group_9_3__0");
					put(grammarAccess.getEClassMappingAccess().getGroup(), "rule__EClassMapping__Group__0");
					put(grammarAccess.getEClassMappingAccess().getGroup_2(), "rule__EClassMapping__Group_2__0");
					put(grammarAccess.getEClassMappingAccess().getGroup_5(), "rule__EClassMapping__Group_5__0");
					put(grammarAccess.getEClassMappingAccess().getGroup_6(), "rule__EClassMapping__Group_6__0");
					put(grammarAccess.getEClassMappingAccess().getGroup_7(), "rule__EClassMapping__Group_7__0");
					put(grammarAccess.getEClassMappingAccess().getGroup_7_2(), "rule__EClassMapping__Group_7_2__0");
					put(grammarAccess.getEClassMappingAccess().getGroup_8(), "rule__EClassMapping__Group_8__0");
					put(grammarAccess.getLifeCycleImplementationAccess().getGroup(), "rule__LifeCycleImplementation__Group__0");
					put(grammarAccess.getEventHandlerAccess().getGroup(), "rule__EventHandler__Group__0");
					put(grammarAccess.getEventHandlerAccess().getGroup_1(), "rule__EventHandler__Group_1__0");
					put(grammarAccess.getInterfaceMethodImplementationAccess().getGroup(), "rule__InterfaceMethodImplementation__Group__0");
					put(grammarAccess.getInterfaceMethodImplementationAccess().getGroup_1(), "rule__InterfaceMethodImplementation__Group_1__0");
					put(grammarAccess.getInterfaceMethodImplementationAccess().getGroup_2(), "rule__InterfaceMethodImplementation__Group_2__0");
					put(grammarAccess.getEFeatureMappingAccess().getGroup(), "rule__EFeatureMapping__Group__0");
					put(grammarAccess.getEFeatureMappingAccess().getGroup_1(), "rule__EFeatureMapping__Group_1__0");
					put(grammarAccess.getEFeatureMappingAccess().getGroup_2(), "rule__EFeatureMapping__Group_2__0");
					put(grammarAccess.getEFeatureMappingAccess().getGroup_3(), "rule__EFeatureMapping__Group_3__0");
					put(grammarAccess.getEFeatureMappingAccess().getGroup_4(), "rule__EFeatureMapping__Group_4__0");
					put(grammarAccess.getEFeatureMappingOptionsAccess().getGroup(), "rule__EFeatureMappingOptions__Group__0");
					put(grammarAccess.getEFeatureMappingOptionsAccess().getGroup_1(), "rule__EFeatureMappingOptions__Group_1__0");
					put(grammarAccess.getEDataTypeMappingAccess().getGroup(), "rule__EDataTypeMapping__Group__0");
					put(grammarAccess.getEEnumMappingAccess().getGroup(), "rule__EEnumMapping__Group__0");
					put(grammarAccess.getEEnumLiteralMappingAccess().getGroup(), "rule__EEnumLiteralMapping__Group__0");
					put(grammarAccess.getFeatureMappingStrategyAccess().getGroup(), "rule__FeatureMappingStrategy__Group__0");
					put(grammarAccess.getFeatureMappingStrategyAccess().getGroup_2(), "rule__FeatureMappingStrategy__Group_2__0");
					put(grammarAccess.getFeatureMappingStrategyAccess().getGroup_5(), "rule__FeatureMappingStrategy__Group_5__0");
					put(grammarAccess.getFeatureMappingStrategyPatternAccess().getGroup(), "rule__FeatureMappingStrategyPattern__Group__0");
					put(grammarAccess.getFeatureMappingStrategyPatternAccess().getGroup_2(), "rule__FeatureMappingStrategyPattern__Group_2__0");
					put(grammarAccess.getFeatureMappingStrategyPatternAccess().getGroup_2_1(), "rule__FeatureMappingStrategyPattern__Group_2_1__0");
					put(grammarAccess.getFeatureMappingStrategyPatternAccess().getGroup_4(), "rule__FeatureMappingStrategyPattern__Group_4__0");
					put(grammarAccess.getFeatureMappingStrategyMethodPatternAccess().getGroup(), "rule__FeatureMappingStrategyMethodPattern__Group__0");
					put(grammarAccess.getJvmFieldAccess().getGroup(), "rule__JvmField__Group__0");
					put(grammarAccess.getJvmOperationAccess().getGroup(), "rule__JvmOperation__Group__0");
					put(grammarAccess.getJvmOperationAccess().getGroup_3(), "rule__JvmOperation__Group_3__0");
					put(grammarAccess.getJvmOperationAccess().getGroup_3_1(), "rule__JvmOperation__Group_3_1__0");
					...
					put(grammarAccess.getFIDAccess().getGroup(), "rule__FID__Group__0");
					put(grammarAccess.getFIDAccess().getGroup_1(), "rule__FID__Group_1__0");
					put(grammarAccess.getFIDAccess().getGroup_1_1(), "rule__FID__Group_1_1__0");
					put(grammarAccess.getFIDAccess().getGroup_1_1_1(), "rule__FID__Group_1_1_1__0");
					...
					put(grammarAccess.getFacadeModelAccess().getGenModelAssignment_2(), "rule__FacadeModel__GenModelAssignment_2");
					put(grammarAccess.getFacadeModelAccess().getNameAssignment_3_1(), "rule__FacadeModel__NameAssignment_3_1");
					put(grammarAccess.getFacadeModelAccess().getUsesFacadeModelsAssignment_4_1(), "rule__FacadeModel__UsesFacadeModelsAssignment_4_1");
					put(grammarAccess.getFacadeModelAccess().getUsesFacadeModelsAssignment_4_2_1(), "rule__FacadeModel__UsesFacadeModelsAssignment_4_2_1");
					put(grammarAccess.getFacadeModelAccess().getImportsAssignment_5(), "rule__FacadeModel__ImportsAssignment_5");
					put(grammarAccess.getFacadeModelAccess().getFeatureMappingStrategiesAssignment_6(), "rule__FacadeModel__FeatureMappingStrategiesAssignment_6");
					put(grammarAccess.getFacadeModelAccess().getFeatureMappingDefaultsAssignment_7_1(), "rule__FacadeModel__FeatureMappingDefaultsAssignment_7_1");
					put(grammarAccess.getFacadeModelAccess().getClassifierMappingsAssignment_8(), "rule__FacadeModel__ClassifierMappingsAssignment_8");
					put(grammarAccess.getFacadeModelAccess().getEPackagesAssignment_9_2(), "rule__FacadeModel__EPackagesAssignment_9_2");
					put(grammarAccess.getFacadeModelAccess().getEPackagesAssignment_9_3_1(), "rule__FacadeModel__EPackagesAssignment_9_3_1");
					put(grammarAccess.getEClassMappingAccess().getEClassAssignment_1(), "rule__EClassMapping__EClassAssignment_1");
					put(grammarAccess.getEClassMappingAccess().getNameAssignment_2_1(), "rule__EClassMapping__NameAssignment_2_1");
					put(grammarAccess.getEClassMappingAccess().getJClassAssignment_4(), "rule__EClassMapping__JClassAssignment_4");
					put(grammarAccess.getEClassMappingAccess().getFeatureMappingDefaultsAssignment_5_1(), "rule__EClassMapping__FeatureMappingDefaultsAssignment_5_1");
					put(grammarAccess.getEClassMappingAccess().getLifeCycleHandlerAssignment_6_1(), "rule__EClassMapping__LifeCycleHandlerAssignment_6_1");
					put(grammarAccess.getEClassMappingAccess().getFeatureMappingsAssignment_7_1(), "rule__EClassMapping__FeatureMappingsAssignment_7_1");
					put(grammarAccess.getEClassMappingAccess().getFeatureMappingsAssignment_7_2_1(), "rule__EClassMapping__FeatureMappingsAssignment_7_2_1");
					put(grammarAccess.getEClassMappingAccess().getEventHandlersAssignment_8_1(), "rule__EClassMapping__EventHandlersAssignment_8_1");
					put(grammarAccess.getLifeCycleImplementationAccess().getMethodImplementationsAssignment_1(), "rule__LifeCycleImplementation__MethodImplementationsAssignment_1");
					put(grammarAccess.getEventHandlerAccess().getInterfaceTypeAssignment_0(), "rule__EventHandler__InterfaceTypeAssignment_0");
					put(grammarAccess.getEventHandlerAccess().getMethodImplementationsAssignment_1_1(), "rule__EventHandler__MethodImplementationsAssignment_1_1");
					put(grammarAccess.getInterfaceMethodImplementationAccess().getInterfaceMethodAssignment_0(), "rule__InterfaceMethodImplementation__InterfaceMethodAssignment_0");
					put(grammarAccess.getInterfaceMethodImplementationAccess().getNameAssignment_1_1(), "rule__InterfaceMethodImplementation__NameAssignment_1_1");
					put(grammarAccess.getInterfaceMethodImplementationAccess().getMethodBodyAssignment_2_1(), "rule__InterfaceMethodImplementation__MethodBodyAssignment_2_1");
					put(grammarAccess.getEFeatureMappingAccess().getEFeatureAssignment_0(), "rule__EFeatureMapping__EFeatureAssignment_0");
					put(grammarAccess.getEFeatureMappingAccess().getNameAssignment_1_1(), "rule__EFeatureMapping__NameAssignment_1_1");
					put(grammarAccess.getEFeatureMappingAccess().getJClassAssignment_2_1(), "rule__EFeatureMapping__JClassAssignment_2_1");
					put(grammarAccess.getEFeatureMappingAccess().getOptionsAssignment_3_1(), "rule__EFeatureMapping__OptionsAssignment_3_1");
					put(grammarAccess.getEFeatureMappingAccess().getMethodImplementationsAssignment_4_1(), "rule__EFeatureMapping__MethodImplementationsAssignment_4_1");
					put(grammarAccess.getEFeatureMappingOptionsAccess().getStrategyAssignment_1_1(), "rule__EFeatureMappingOptions__StrategyAssignment_1_1");
					put(grammarAccess.getEDataTypeMappingAccess().getEDataTypeAssignment_1(), "rule__EDataTypeMapping__EDataTypeAssignment_1");
					put(grammarAccess.getEDataTypeMappingAccess().getJClassAssignment_3(), "rule__EDataTypeMapping__JClassAssignment_3");
					put(grammarAccess.getEDataTypeMappingAccess().getConvertExpressionAssignment_5(), "rule__EDataTypeMapping__ConvertExpressionAssignment_5");
					put(grammarAccess.getEEnumMappingAccess().getEDataTypeAssignment_1(), "rule__EEnumMapping__EDataTypeAssignment_1");
					put(grammarAccess.getEEnumMappingAccess().getJClassAssignment_3(), "rule__EEnumMapping__JClassAssignment_3");
					put(grammarAccess.getEEnumMappingAccess().getLiteralMappingsAssignment_4(), "rule__EEnumMapping__LiteralMappingsAssignment_4");
					put(grammarAccess.getEEnumMappingAccess().getConvertExpressionAssignment_6(), "rule__EEnumMapping__ConvertExpressionAssignment_6");
					put(grammarAccess.getEEnumLiteralMappingAccess().getEnumLiteralAssignment_0(), "rule__EEnumLiteralMapping__EnumLiteralAssignment_0");
					put(grammarAccess.getEEnumLiteralMappingAccess().getConvertExpressionAssignment_2(), "rule__EEnumLiteralMapping__ConvertExpressionAssignment_2");
					put(grammarAccess.getFeatureMappingStrategyAccess().getImplTypeAssignment_1(), "rule__FeatureMappingStrategy__ImplTypeAssignment_1");
					put(grammarAccess.getFeatureMappingStrategyAccess().getNameAssignment_2_1(), "rule__FeatureMappingStrategy__NameAssignment_2_1");
					put(grammarAccess.getFeatureMappingStrategyAccess().getInterfaceTypeAssignment_4(), "rule__FeatureMappingStrategy__InterfaceTypeAssignment_4");
					put(grammarAccess.getFeatureMappingStrategyAccess().getPatternsAssignment_5_1(), "rule__FeatureMappingStrategy__PatternsAssignment_5_1");
					put(grammarAccess.getFeatureMappingStrategyPatternAccess().getFeatureNameAssignment_0(), "rule__FeatureMappingStrategyPattern__FeatureNameAssignment_0");
					put(grammarAccess.getFeatureMappingStrategyPatternAccess().getTypeParametersAssignment_2_0(), "rule__FeatureMappingStrategyPattern__TypeParametersAssignment_2_0");
					put(grammarAccess.getFeatureMappingStrategyPatternAccess().getTypeParametersAssignment_2_1_1(), "rule__FeatureMappingStrategyPattern__TypeParametersAssignment_2_1_1");
					put(grammarAccess.getFeatureMappingStrategyPatternAccess().getMethodPatternsAssignment_4_1(), "rule__FeatureMappingStrategyPattern__MethodPatternsAssignment_4_1");
					put(grammarAccess.getJvmTypeParameterAccess().getNameAssignment(), "rule__JvmTypeParameter__NameAssignment");
					put(grammarAccess.getFeatureMappingStrategyMethodPatternAccess().getStrategyMethodAssignment_0(), "rule__FeatureMappingStrategyMethodPattern__StrategyMethodAssignment_0");
					put(grammarAccess.getFeatureMappingStrategyMethodPatternAccess().getTargetMemberAssignment_2(), "rule__FeatureMappingStrategyMethodPattern__TargetMemberAssignment_2");
					put(grammarAccess.getFeatureMappingStrategyMethodPatternAccess().getTargetBodyAssignment_4(), "rule__FeatureMappingStrategyMethodPattern__TargetBodyAssignment_4");
					put(grammarAccess.getJvmFieldAccess().getTypeAssignment_1(), "rule__JvmField__TypeAssignment_1");
					put(grammarAccess.getJvmFieldAccess().getSimpleNameAssignment_2(), "rule__JvmField__SimpleNameAssignment_2");
					put(grammarAccess.getJvmOperationAccess().getReturnTypeAssignment_0(), "rule__JvmOperation__ReturnTypeAssignment_0");
					put(grammarAccess.getJvmOperationAccess().getSimpleNameAssignment_1(), "rule__JvmOperation__SimpleNameAssignment_1");
					put(grammarAccess.getJvmOperationAccess().getParametersAssignment_3_0(), "rule__JvmOperation__ParametersAssignment_3_0");
					put(grammarAccess.getJvmOperationAccess().getParametersAssignment_3_1_1(), "rule__JvmOperation__ParametersAssignment_3_1_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.gmt.ui.contentassist.antlr.internal.InternalEmfacadeParser typedParser = (org.eclipse.gmt.ui.contentassist.antlr.internal.InternalEmfacadeParser) parser;
			typedParser.entryRuleFacadeModel();
